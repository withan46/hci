...
| 8 | [Άσκηση προγραμματισμού (Menu CSS)](#παραδοτέο-8) |
...
•	Βιβλιογραφία/Πηγές : 
   ...
   •  Link άσκησης: 
      https://objective-babbage-53393c.netlify.app/remix/menu-css/
...
### Menu CSS
   ...
   <img src="https://i.imgur.com/9iwhU2d.png" width="587" height="489" />

      
    
   •  Βιβλιογραφία/Πηγές : 
      https://cdn.hipwallpaper.com/i/69/49/hTkBZr.jpg(background image)
      https://www.w3schools.com/cssref/css3_pr_box-shadow.asp(box shadow)
      https://www.w3schools.com/cssref/pr_background-image.asp(resize baground image)
